...
[배포처 바로가기](http://www.earlyfont.com/portfolio/EF_REBECCA)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `Rebecca`입니다.
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/Rebecca/subsets/Rebecca-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/Rebecca/subsets/Rebecca-dynamic-subset.css');
```
...
```css
font-family: "Rebecca", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
